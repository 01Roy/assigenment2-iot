  ...
  return (
    <div className="">
      <div className="w-[30rem] h-[10rem] bg-[#D9D9D9] relative rounded-2xl mt-[8rem] ml-[-2rem]">
        <div className="absolute w-[29.7rem] h-[9.8rem] bg-cover top-[2px] left-[1px] rounded-xl ">
          <img
            src="https://res.cloudinary.com/dcnjbnpnl/image/upload/fl_preserve_transparency/v1714060847/Rectangle29_fomsv4.jpg?_s=public-apps"
            alt=""
            className="absolute w-[29.7rem] h-[9.7rem] bg-cover top-[1px]  rounded-xl"
          />
